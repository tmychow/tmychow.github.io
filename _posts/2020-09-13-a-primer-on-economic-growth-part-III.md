...
**Note**: There's now a version in Stata [here](https://tmychow.com/blog/2021/02/04/reg-y-x) - and as per people's requests, the Stata version involves testing MRW against newer data, rather than merely replicating their paper.
